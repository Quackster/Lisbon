...
import net.h4bbo.lisbon.game.games.battleball.BattleBallMap;
import net.h4bbo.lisbon.game.games.history.GameHistory;
import net.h4bbo.lisbon.game.games.history.GameHistoryData;
import net.h4bbo.lisbon.game.games.player.GameRank;
...
public class GameDao {
    ...
    public static List<GameHistory> getLastPlayedGames(GameType gameType) {
        ...
        try {
            ...
            while (resultSet.next()) {
                var gameHistory = new GameHistory(Lisbon.getGson().fromJson(resultSet.getString("team_data"), GameHistoryData.class));
