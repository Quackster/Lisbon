...
import net.h4bbo.lisbon.game.games.battleball.events.AcquirePowerUpEvent;
import net.h4bbo.lisbon.game.games.battleball.objects.PowerObject;
import net.h4bbo.lisbon.game.games.battleball.objects.PowerUpUpdateObject;
