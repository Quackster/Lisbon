package net.h4bbo.lisbon.game.games.tasks;
    ...
    public void run() {
        ...
        if (this.game.canIncreasePoints()) {
            ...
            if (saveScore) {
                ...
                GameDao.saveTeamHistory(uniqueId, this.gameHistory.getName(), this.game.getGameCreatorId(), this.gameHistory.getMapId(), this.gameHistory.getWinningTeam(), this.gameHistory.getWinningTeamScore(), this.gameHistory.getExtraData(), this.gameType, Lisbon.getGson().toJson(this.gameHistory.getGameHistoryData()));
