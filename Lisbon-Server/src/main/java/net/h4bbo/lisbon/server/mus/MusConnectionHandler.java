package net.h4bbo.lisbon.server.mus;
...
import net.h4bbo.lisbon.dao.mysql.PhotoDao;
...
import net.h4bbo.lisbon.game.item.Photo;
...
import net.h4bbo.lisbon.server.mus.connection.MusClient;
import net.h4bbo.lisbon.server.mus.streams.MusMessage;
import net.h4bbo.lisbon.server.mus.streams.MusPropList;
import net.h4bbo.lisbon.server.mus.streams.MusTypes;
...
public class MusConnectionHandler extends SimpleChannelInboundHandler<MusMessage> {
    ...
    public void channelRegistered(ChannelHandlerContext ctx) {
        if (!this.server.getChannels().add(ctx.channel()) || Lisbon.isShuttingdown()) {
