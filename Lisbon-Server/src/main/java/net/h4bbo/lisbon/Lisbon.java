...
import net.h4bbo.lisbon.game.misc.figure.FigureManager;
import net.h4bbo.lisbon.game.moderation.ChatManager;
...
import net.h4bbo.lisbon.messages.MessageHandler;
import net.h4bbo.lisbon.server.mus.MusServer;
import net.h4bbo.lisbon.server.netty.NettyServer;
import net.h4bbo.lisbon.server.rcon.RconServer;
import net.h4bbo.lisbon.util.DateUtil;
import net.h4bbo.lisbon.util.config.GameConfiguration;
import net.h4bbo.lisbon.util.config.LoggingConfiguration;
import net.h4bbo.lisbon.util.config.ServerConfiguration;
import net.h4bbo.lisbon.util.config.writer.DefaultConfigWriter;
...
public class Lisbon {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Runtime.getRuntime().addShutdownHook(new Thread(Lisbon::dispose));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
