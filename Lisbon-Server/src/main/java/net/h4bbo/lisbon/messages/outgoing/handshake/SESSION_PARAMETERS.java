...
public class SESSION_PARAMETERS extends MessageComposer {
    ...
    public void compose(NettyResponse response) {
        ...
        parameters.put(SessionParamType.TUTORIAL_ENABLED, true ? "1" : "0");//GameConfiguration.getInstance().getBoolean("tutorial.enabled") ? "1" : "0"); // tutorial_enabled. Value is either 1 or 0 (enabled or disabled)
    ...
    /*
    private boolean isTutorialEnabled(Player player) {
