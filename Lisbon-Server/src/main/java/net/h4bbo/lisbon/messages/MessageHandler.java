...
import net.h4bbo.lisbon.messages.incoming.catalogue.GCIX;
import net.h4bbo.lisbon.messages.incoming.catalogue.GET_ALIAS_LIST;
import net.h4bbo.lisbon.messages.incoming.catalogue.GRPC;
import net.h4bbo.lisbon.messages.incoming.club.GET_CLUB;
import net.h4bbo.lisbon.messages.incoming.club.SCR_GIFT_APPROVAL;
import net.h4bbo.lisbon.messages.incoming.club.SUBSCRIBE_CLUB;
...
import net.h4bbo.lisbon.messages.incoming.infobus.TRYBUS;
import net.h4bbo.lisbon.messages.incoming.infobus.VOTE;
import net.h4bbo.lisbon.messages.incoming.inventory.GETSTRIP;
import net.h4bbo.lisbon.messages.incoming.jukebox.*;
import net.h4bbo.lisbon.messages.incoming.messenger.*;
import net.h4bbo.lisbon.messages.incoming.moderation.*;
import net.h4bbo.lisbon.messages.incoming.navigator.*;
import net.h4bbo.lisbon.messages.incoming.pets.GETPETSTAT;
import net.h4bbo.lisbon.messages.incoming.purse.GETUSERCREDITLOG;
import net.h4bbo.lisbon.messages.incoming.purse.REDEEM_VOUCHER;
import net.h4bbo.lisbon.messages.incoming.recycler.CONFIRM_FURNI_RECYCLING;
import net.h4bbo.lisbon.messages.incoming.recycler.GET_FURNI_RECYCLER_CONFIGURATION;
import net.h4bbo.lisbon.messages.incoming.recycler.GET_FURNI_RECYCLER_STATUS;
...
import net.h4bbo.lisbon.messages.incoming.rooms.dimmer.MSG_ROOMDIMMER_SET_PRESET;
import net.h4bbo.lisbon.messages.incoming.rooms.items.*;
import net.h4bbo.lisbon.messages.incoming.rooms.moderation.*;
